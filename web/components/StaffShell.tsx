    ...
    <div className="shell">
      ...
      <aside className={`sidebar ${open ? 'open' : ''}`}>
        ...
        <nav className="side-scroll">
          ...
          <Link href="/staff/sign-requests" className={`nav-item ${pathname.startsWith('/staff/sign-requests') ? 'active' : ''}`} onClick={() => setOpen(false)}>
            <i className="fa-solid fa-file-pen" /><span>Documents to sign</span>
          </Link>
          ...
          <Link href="/staff/forms" className={`nav-item ${pathname.startsWith('/staff/forms') ? 'active' : ''}`} onClick={() => setOpen(false)}>
            <i className="fa-solid fa-file-signature" /><span>Forms</span>
          </Link>
          ...
          <Link href="/staff/exits" className={`nav-item ${pathname.startsWith('/staff/exits') ? 'active' : ''}`} onClick={() => setOpen(false)}>
            <i className="fa-solid fa-right-from-bracket" /><span>Exits</span>
          </Link>
          ...
          {isAdmin(profile?.role) ? (
            <Link href="/staff/security" className={`nav-item ${pathname.startsWith('/staff/security') ? 'active' : ''}`} onClick={() => setOpen(false)}>
              <i className="fa-solid fa-shield-halved" /><span>Security</span>
            </Link>
          ) : (
            <div className="nav-item" style={{ opacity: 0.45, cursor: 'not-allowed' }} title="Admin / Chairlady only">
              <i className="fa-solid fa-shield-halved" /><span>Security</span>
